...
#ifndef SWEEPI_ROBOT_MANAGER_INTERFACES__SRV__DETAIL__START_TASK__FUNCTIONS_H_
#define SWEEPI_ROBOT_MANAGER_INTERFACES__SRV__DETAIL__START_TASK__FUNCTIONS_H_
...
#include "sweepi_robot_manager_interfaces/msg/rosidl_generator_c__visibility_control.h"
 ...
 * )) before or use
 * sweepi_robot_manager_interfaces__srv__StartTask_Request__create()
 ...
 * calls
 * sweepi_robot_manager_interfaces__srv__StartTask_Request__init().
...
/**
 * It calls
 * sweepi_robot_manager_interfaces__srv__StartTask_Request__fini()
...
/**
 * It calls
 * sweepi_robot_manager_interfaces__srv__StartTask_Request__Sequence__fini()
 * on the array,
 ...
 * )) before or use
 * sweepi_robot_manager_interfaces__srv__StartTask_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_sweepi_robot_manager_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * sweepi_robot_manager_interfaces__srv__StartTask_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_sweepi_robot_manager_interfaces
...
/**
 * It calls
 * sweepi_robot_manager_interfaces__srv__StartTask_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_sweepi_robot_manager_interfaces
...
/**
 * It calls
 * sweepi_robot_manager_interfaces__srv__StartTask_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * sweepi_robot_manager_interfaces__srv__StartTask_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_sweepi_robot_manager_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * sweepi_robot_manager_interfaces__srv__StartTask_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_sweepi_robot_manager_interfaces
...
/**
 * It calls
 * sweepi_robot_manager_interfaces__srv__StartTask_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_sweepi_robot_manager_interfaces
...
/**
 * It allocates the memory for the array and calls
 * sweepi_robot_manager_interfaces__srv__StartTask_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_sweepi_robot_manager_interfaces
...
/**
 * It calls
 * sweepi_robot_manager_interfaces__srv__StartTask_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SWEEPI_ROBOT_MANAGER_INTERFACES__SRV__DETAIL__START_TASK__FUNCTIONS_H_
