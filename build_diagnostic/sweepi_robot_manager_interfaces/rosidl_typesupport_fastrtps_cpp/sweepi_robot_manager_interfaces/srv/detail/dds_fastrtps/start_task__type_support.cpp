...
#include "sweepi_robot_manager_interfaces/srv/detail/start_task__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_sweepi_robot_manager_interfaces
cdr_serialize(
  const sweepi_robot_manager_interfaces::srv::StartTask_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sweepi_robot_manager_interfaces::srv::StartTask_Request & ros_message)
{
  // Member: map_name
  cdr >> ros_message.map_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sweepi_robot_manager_interfaces::srv::StartTask_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sweepi_robot_manager_interfaces::srv::StartTask_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sweepi_robot_manager_interfaces::srv::StartTask_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_sweepi_robot_manager_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<sweepi_robot_manager_interfaces::srv::StartTask_Request>()
{
  return &sweepi_robot_manager_interfaces::srv::typesupport_fastrtps_cpp::_StartTask_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sweepi_robot_manager_interfaces, srv, StartTask_Request)() {
  return &sweepi_robot_manager_interfaces::srv::typesupport_fastrtps_cpp::_StartTask_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_sweepi_robot_manager_interfaces
cdr_serialize(
  const sweepi_robot_manager_interfaces::srv::StartTask_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sweepi_robot_manager_interfaces::srv::StartTask_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = sweepi_robot_manager_interfaces::srv::StartTask_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sweepi_robot_manager_interfaces::srv::StartTask_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<sweepi_robot_manager_interfaces::srv::StartTask_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &sweepi_robot_manager_interfaces::srv::typesupport_fastrtps_cpp::_StartTask_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sweepi_robot_manager_interfaces, srv, StartTask_Response)() {
  return &sweepi_robot_manager_interfaces::srv::typesupport_fastrtps_cpp::_StartTask_Response__handle;
}
...
// functions for sweepi_robot_manager_interfaces::srv::StartTask_Request already declared above

// functions for sweepi_robot_manager_interfaces::srv::StartTask_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_sweepi_robot_manager_interfaces
cdr_serialize(
  const sweepi_robot_manager_interfaces::srv::StartTask_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      sweepi_robot_manager_interfaces::srv::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sweepi_robot_manager_interfaces::srv::StartTask_Event & ros_message)
{
  // Member: info
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      sweepi_robot_manager_interfaces::srv::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        sweepi_robot_manager_interfaces::srv::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        sweepi_robot_manager_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_StartTask_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        sweepi_robot_manager_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_StartTask_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = sweepi_robot_manager_interfaces::srv::StartTask_Event;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      sweepi_robot_manager_interfaces::srv::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.request[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        sweepi_robot_manager_interfaces::srv::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.request[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        sweepi_robot_manager_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_StartTask_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        sweepi_robot_manager_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_StartTask_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const sweepi_robot_manager_interfaces::srv::StartTask_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<sweepi_robot_manager_interfaces::srv::StartTask_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &sweepi_robot_manager_interfaces::srv::typesupport_fastrtps_cpp::_StartTask_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sweepi_robot_manager_interfaces, srv, StartTask_Event)() {
  return &sweepi_robot_manager_interfaces::srv::typesupport_fastrtps_cpp::_StartTask_Event__handle;
}
...
static const rosidl_service_type_support_t _StartTask__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<sweepi_robot_manager_interfaces::srv::StartTask_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<sweepi_robot_manager_interfaces::srv::StartTask_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<sweepi_robot_manager_interfaces::srv::StartTask_Event>(),
...
{
  return &sweepi_robot_manager_interfaces::srv::typesupport_fastrtps_cpp::_StartTask__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sweepi_robot_manager_interfaces, srv, StartTask)() {
  return &sweepi_robot_manager_interfaces::srv::typesupport_fastrtps_cpp::_StartTask__handle;
}
